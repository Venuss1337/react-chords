...
const Chord = ({ chord, instrument, lite = false }) => {
    var _a;
    if (!(chord === null || chord === void 0 ? void 0 : chord.frets)) {
        return null;
    }
    if (isPianoChord(chord, instrument)) {
        return ((0, jsx_runtime_1.jsx)("svg", { width: '100%', xmlns: 'http://www.w3.org/2000/svg', preserveAspectRatio: 'xMinYMin meet', viewBox: '0 0 80 70', children: (0, jsx_runtime_1.jsx)("g", { transform: 'translate(5, 13)', children: (0, jsx_runtime_1.jsx)(index_js_4.default, { chord: chord, lite: lite }) }) }));
    }
    if (!isStringChord(chord) || !isStringInstrument(instrument)) {
        return null;
    }
    return ((0, jsx_runtime_1.jsx)("svg", { width: '100%', xmlns: 'http://www.w3.org/2000/svg', preserveAspectRatio: 'xMinYMin meet', viewBox: '0 0 80 70', children: (0, jsx_runtime_1.jsxs)("g", { transform: 'translate(13, 13)', children: [(0, jsx_runtime_1.jsx)(index_js_1.default, { tuning: instrument.tunings.standard, strings: instrument.strings, frets: chord.frets, capo: chord.capo, fretsOnChord: instrument.fretsOnChord, baseFret: chord.baseFret, lite: lite }), (_a = chord.barres) === null || _a === void 0 ? void 0 : _a.map((barre, index) => {
                    var _a;
