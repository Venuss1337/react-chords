...
const Neck = ({ tuning, frets, strings, fretsOnChord, baseFret = 1, capo, lite = false }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)("path", { stroke: '#444', strokeWidth: '0.25', strokeLinecap: 'square', strokeLinejoin: 'miter', d: getNeckPath(strings, fretsOnChord) }), baseFret === 1
                ? ((0, jsx_runtime_1.jsx)("path", { stroke: '#444', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round', d: `M ${offset.x} 0 H ${offset.length}` }))
                : ((0, jsx_runtime_1.jsxs)("text", { fontSize: '0.25rem', fill: '#444', fontFamily: 'Verdana', x: getBarreOffset(strings, frets, baseFret, capo), y: '8', children: [baseFret, "fr"] })), !lite && ((0, jsx_runtime_1.jsx)("g", { children: tuning.slice().map((note, index) => ((0, jsx_runtime_1.jsx)("text", { fontSize: '0.3rem', fill: '#444', fontFamily: 'Verdana', textAnchor: 'middle', x: offset.x + index * 10, y: '53', children: note }, index))) }))] }));
};
