...
const Barre = ({ barre, frets, capo, finger, lite = false }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [capo && ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)("g", { transform: `translate(${getStringPosition(strings, strings)}, ${positions.fret[barreFrets[0].value]})`, children: (0, jsx_runtime_1.jsx)("path", { d: `
                ...
                m -4, 0
                a 4,4 0 1,1 8,0
              `, fill: 'currentColor', fillOpacity: 0.2, transform: 'rotate(-90)' }) }), (0, jsx_runtime_1.jsx)("rect", { fill: 'currentColor', x: xPositions[0], y: fretYPosition[barre - 1], width: (strings - 1) * 10, fillOpacity: 0.2, height: 8.25 }), (0, jsx_runtime_1.jsx)("g", { transform: `translate(${getStringPosition(1, strings)}, ${positions.fret[barreFrets[0].value]})`, children: (0, jsx_runtime_1.jsx)("path", { d: `
                M 0, 0
                m -4, 0
                a 4,4 0 1,1 8,0
              `, fill: 'currentColor', fillOpacity: 0.2, transform: 'rotate(90)' }) })] })), barreFrets.map(fret => ((0, jsx_runtime_1.jsx)("circle", { strokeWidth: '0.25', stroke: 'inherit', fill: 'currentColor', cx: getStringPosition(strings - fret.position, strings), cy: positions.fret[fret.value], r: 4 }, fret.position))), (0, jsx_runtime_1.jsx)("rect", { fill: 'currentColor', x: xPositions[string1], y: y, width: width, height: 8.25 }), !lite && finger && barreFrets.map(fret => ((0, jsx_runtime_1.jsx)("text", { fontSize: '3pt', fontFamily: 'Verdana', textAnchor: 'middle', fill: 'white', x: getStringPosition(strings - fret.position, strings), y: positions.finger[fret.value], children: finger }, fret.position)))] }));
};
