...
const Piano = ({ chord, lite = false }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [whiteKeys.map((note, i) => {
                ...
                return ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("rect", { x: i * 10, y: 0, width: 10, height: 48, fill: isPressed ? '#e5e7eb' : '#ffffff', stroke: 'inherit', strokeWidth: '0.25' }), isPressed && ((0, jsx_runtime_1.jsx)("text", { x: (i * 10) + 5, y: 42, textAnchor: 'middle', fontSize: '3px', fontFamily: 'Arial', fill: '#000', children: `${note}4` }))] }, `white-${note}`));
                ...
                return ((0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("rect", { x: (i * 10) + 7, y: 0, width: 6, height: 30, fill: isPressed ? '#e5e7eb' : '#000000', stroke: 'inherit', strokeWidth: '0.25' }), isPressed && ((0, jsx_runtime_1.jsx)("text", { x: (i * 10) + 10, y: 25, textAnchor: 'middle', fontSize: '2.5px', fontFamily: 'Arial', fill: '#000', children: `${blackNote}4` }))] }, `black-${blackNote}`));
            }), !lite && chord.octave && ((0, jsx_runtime_1.jsxs)("text", { fontSize: '0.3rem', fill: 'currentColor', fontFamily: 'Verdana', x: -12, y: 24, children: ["Octave: ", chord.octave] }))] }));
};
