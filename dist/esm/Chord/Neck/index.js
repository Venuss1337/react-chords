...
const Neck = ({ tuning, frets, strings, fretsOnChord, baseFret = 1, capo, lite = false }) => {
    ...
    return (_jsxs("g", { children: [_jsx("path", { stroke: '#444', strokeWidth: '0.25', strokeLinecap: 'square', strokeLinejoin: 'miter', d: getNeckPath(strings, fretsOnChord) }), baseFret === 1
                ? (_jsx("path", { stroke: '#444', strokeWidth: '2', strokeLinecap: 'round', strokeLinejoin: 'round', d: `M ${offset.x} 0 H ${offset.length}` }))
                : (_jsxs("text", { fontSize: '0.25rem', fill: '#444', fontFamily: 'Verdana', x: getBarreOffset(strings, frets, baseFret, capo), y: '8', children: [baseFret, "fr"] })), !lite && (_jsx("g", { children: tuning.slice().map((note, index) => (_jsx("text", { fontSize: '0.3rem', fill: '#444', fontFamily: 'Verdana', textAnchor: 'middle', x: offset.x + index * 10, y: '53', children: note }, index))) }))] }));
};
export default Neck;
