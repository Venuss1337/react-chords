...
const Chord = ({ chord, instrument, lite = false }) => {
    ...
    if (isPianoChord(chord, instrument)) {
        return (_jsx("svg", { width: '100%', xmlns: 'http://www.w3.org/2000/svg', preserveAspectRatio: 'xMinYMin meet', viewBox: '0 0 80 70', children: _jsx("g", { transform: 'translate(5, 13)', children: _jsx(Piano, { chord: chord, lite: lite }) }) }));
    }
    if (!isStringChord(chord) || !isStringInstrument(instrument)) {
        return null;
    }
    return (_jsx("svg", { width: '100%', xmlns: 'http://www.w3.org/2000/svg', preserveAspectRatio: 'xMinYMin meet', viewBox: '0 0 80 70', children: _jsxs("g", { transform: 'translate(13, 13)', children: [_jsx(Neck, { tuning: instrument.tunings.standard, strings: instrument.strings, frets: chord.frets, capo: chord.capo, fretsOnChord: instrument.fretsOnChord, baseFret: chord.baseFret, lite: lite }), (_a = chord.barres) === null || _a === void 0 ? void 0 : _a.map((barre, index) => {
                    var _a;
